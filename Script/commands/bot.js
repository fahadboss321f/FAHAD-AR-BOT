...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "🥴") || (event.body.toLowerCase() == "help")) {
     return api.sendMessage("তোর চোখ কানা রে সালা 🌚👀", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@Fahad Boss") || (event.body.toLowerCase() == "@Fahad Boss") || (event.body.toLowerCase() == "@Ullash ッ") || (event.body.toLowerCase() == "উল্লাস")) {
     return api.sendMessage("ওরে মেনসন দিসনা 😡 ও এখন জান্নাত এর সাথে চিপায় আছে 🌚👄🥵",threadID);

       
   };

   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ Fahad Boss ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 ullash.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/profile.php?id=100000654976375\nতার সাতে যোগা যোগ করবেন WhatsApp :- +0175570***", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("Fahad Boss ッ❤️ তাকে সবাই ফাহাদ নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "এই আমি তোর বস ফাহাদ 😡") || (event.body.toLowerCase() == "sala ami ullas") || (event.body.toLowerCase() == "cup sala ami ullash") || (event.body.toLowerCase() == "madari")) {
     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "@Jannati Aktar Nusrat") || (event.body.toLowerCase() == "@Farhana Ontora ")) {
     return api.sendMessage("খবরদার কেউ এই আইডি মেনশন দিবানা এটা আমার বস ফাহাদ এর বউ এর আইডি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Jannat") || (event.body.toLowerCase() == "arohi")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস ফাহাদ এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@MD Shiam Tafeder ") || (event.body.toLowerCase() == "সিয়াম")) {
   ...
   if ((event.body.toLowerCase() == "আমারে কিস দাও ") || (event.body.toLowerCase() == "kiss me")) {
     return api.sendMessag", threadID);
   };

   if ((event.body.toLowerCase() == "কি") || (event.body.toLowerCase() == "ধন্যবাদ") || (event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thanks")) {
     return api.sendMessage("️এতো কি কি করোস কেন পারলে ফাহাদ বস রে একটা বউ দে🌚🥵😒", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>𝗜[ / ] • ] • ➠⎯͢⎯⃝🥵 𝗙𝗔𝗛𝗔𝗗➠𝗔𝗥 ⋆⃝𝗕𝗢𝗧🫦⋆⃝─•", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Madarxud") || (event.body.toLowerCase() == "tor nanire xudi")) {
     return api.sendMessage("️জি বস গালি দেওয়া ভালো না 😘", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "gf") || (event.body.toLowerCase() == "bf")) {
     return api.sendMessage("খালি কি তোরাই পেম করবি বস ফাহাদ রে একটা বউ দে<🥺", threadID);
   };
